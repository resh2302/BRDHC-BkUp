<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="giftShopSendACard.aspx.cs" Theme="HealthTools" Inherits="giftShopSendACard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphSiteMasterBody" runat="Server">
    ...
    <%--panel holding content pre-send--%>
      ...
      <div class="col-xs-12">
       ...
       <%--Panel holding confirmation message post-send--%>
      <asp:Panel ID="pnlMsSent" runat="server" Visible="false" CssClass="msPadBot30 msPadTop30">
        <div class="col-xs-12">
